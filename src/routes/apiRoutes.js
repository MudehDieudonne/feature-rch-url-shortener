 ...
 * items: # Each item in the array is a URL object
 * type: object # Or you can define a reusable schema for Url model and reference it
 * properties: # Define properties of a URL object
 * _id:
 * type: string
...
/**
 * @swagger
 * /api/shorten/{shortCode}/stats: # Use curly braces for path parameter
 * get:
 * summary: Get detailed statistics for a specific short URL owned by the authenticated user.
 * tags:
 * - URLs
 * - Analytics # Add an Analytics tag
 * security:
 * - bearerAuth: [] # Indicates this route requires authentication
 * parameters:
 * - in: path
